...
public class Problem19 {
	private static final int numDaysYear = 365; // 30*4 + 28 + 7*31
	private static final int numDaysLeapYear = 366; // num days of Feb. is 29 instead of 28
	//XXX It can be done without dealing with leap years. 
